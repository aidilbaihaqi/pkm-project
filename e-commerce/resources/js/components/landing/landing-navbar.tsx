            ...
            <div className="container mx-auto px-2 sm:px-4">
                <div className="flex h-12 items-center justify-between gap-2 sm:h-14 sm:gap-4">
                    ...
                    <Link href="/" className="flex shrink-0 items-center gap-1.5 sm:gap-2">
                        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-teal-600 sm:h-8 sm:w-8">
                    ...
                    <button className="flex flex-1 items-center justify-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 text-xs transition-colors hover:bg-gray-200 sm:flex-initial sm:gap-2 sm:px-4 sm:py-2 sm:text-sm dark:bg-gray-800 dark:hover:bg-gray-700">
                        <MapPin className="h-3.5 w-3.5 shrink-0 text-teal-600 sm:h-4 sm:w-4" />
                    ...
                    <div className="hidden flex-1 md:block">
                        <div className="relative mx-auto max-w-md">
                            ...
                            <input
                                ...
                                className="w-full rounded-full border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm outline-none transition-colors focus:border-teal-500 focus:bg-white dark:border-gray-700 dark:bg-gray-800 dark:focus:border-teal-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="border-t border-gray-100 py-2 md:hidden dark:border-gray-800">
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="Cari UMKM atau produk..."
                                autoFocus
                                className="w-full rounded-full border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm outline-none transition-colors focus:border-teal-500 focus:bg-white dark:border-gray-700 dark:bg-gray-800"
                            />
                        </div>
                    </div>
                )}
